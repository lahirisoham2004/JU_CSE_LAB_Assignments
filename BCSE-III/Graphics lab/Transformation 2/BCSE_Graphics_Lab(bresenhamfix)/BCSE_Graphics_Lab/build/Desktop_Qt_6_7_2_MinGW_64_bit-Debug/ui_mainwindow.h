...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ff_time->setGeometry(QRect(750, 680, 91, 21));
        sf_time = new QLabel(centralwidget);
        sf_time->setObjectName("sf_time");
        sf_time->setGeometry(QRect(850, 680, 91, 21));
        boundF = new QPushButton(centralwidget);
        boundF->setObjectName("boundF");
        boundF->setGeometry(QRect(940, 640, 81, 33));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        boundF->setText(QCoreApplication::translate("MainWindow", "Boundary", nullptr));
