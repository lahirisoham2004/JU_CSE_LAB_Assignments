...
private slots:
    ...
    void on_translateO_clicked();

    void on_reflectx_clicked();

    void on_reflecty_clicked();

    void on_scaleO_clicked();

    void on_rotateO_clicked();

    void on_shearO_clicked();

    void on_setRotP_clicked();

    void on_setScaleP_clicked();

    void on_setLineRef_clicked();
...
private:
    ...
    void draw_bresenham_line(int x1, int y1, int x2, int y2, int , int , int);
