...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        DDADraw->setGeometry(QRect(860, 320, 141, 33));
        store = new QPushButton(centralwidget);
        store->setObjectName("store");
        store->setGeometry(QRect(782, 220, 121, 31));
        reset = new QPushButton(centralwidget);
        reset->setObjectName("reset");
        reset->setGeometry(QRect(940, 220, 121, 31));
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(850, 450, 181, 33));
        DDA_TIME = new QLabel(centralwidget);
        DDA_TIME->setObjectName("DDA_TIME");
        DDA_TIME->setGeometry(QRect(790, 380, 271, 31));
        Bresenham_TIME = new QLabel(centralwidget);
        Bresenham_TIME->setObjectName("Bresenham_TIME");
        Bresenham_TIME->setGeometry(QRect(780, 530, 301, 31));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1241, 29));
