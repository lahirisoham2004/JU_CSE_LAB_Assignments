...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setGeometry(QRect(760, 610, 93, 29));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(890, 610, 93, 29));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("MainWindow", "Boundary fill", nullptr));
    } // retranslateUi
