...
void MainWindow :: floodfillutil2(int x, int y, int r, int g, int b, QList<std::pair<int,int>>& visited) {
    int height=ui->workArea->height();
    int width=ui->workArea->width();
    ...
    visited.append(std::make_pair(x,y));
    //delay(1000);
    floodfillutil2(x - gridsize, y, r,g,b, visited);
    floodfillutil2(x + gridsize, y + gridsize, r,g,b, visited);
    floodfillutil2(x + gridsize, y - gridsize, r,g,b, visited);
    floodfillutil2(x - gridsize, y - gridsize, r,g,b, visited);
    floodfillutil2(x - gridsize, y + gridsize, r,g,b, visited);
    floodfillutil2(x + gridsize, y, r,g,b, visited);
    floodfillutil2(x, y - gridsize, r,g,b, visited);
    floodfillutil2(x, y + gridsize, r,g,b, visited);
}

void MainWindow::on_pushButton_3_clicked() //Boundary Fill
{
    ...
    // visited.append(std::make_pair(x,y));
    floodfillutil2(x,y,255,255,0, visited);
}
...
void MainWindow::on_pushButton_2_clicked() //Scanline
{
